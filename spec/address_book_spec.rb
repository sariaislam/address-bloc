...
RSpec.describe AddressBook do
  ...
  describe "#import_from_csv for new csv file" do
    it "imports the correct number of entries" do
    ...
    it "imports the 1st entry" do
      ...
      check_entry(entry_one, "Ezio", "222-222-2222", "ezio@kittymail.com")
    end
    ...
    it "imports the 2nd entry" do
      ...
      check_entry(entry_two, "Judith", "333-333-3333", "judith@dutchmail.com")
    end
    ...
    it "imports the 3rd entry" do
      ...
      check_entry(entry_three, "Miko", "111-111-1111", "miko@kittymail.com")
    end
  end
  ...
  describe "#iterative_search" do
    it "iterates through AddressBook to search for a non-existent entry" do
      book.import_from_csv("entries.csv")
